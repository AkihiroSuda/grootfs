...
type Unpacker interface {
	Unpack(logger lager.Logger, spec UnpackSpec) (uint64, error)
}
...
func (p *BaseImagePuller) unpackLayerToTemporaryDirectory(logger lager.Logger, unpackSpec UnpackSpec, digest LayerDigest) (volSize uint64, err error) {
...
func (p *BaseImagePuller) finalizeVolume(logger lager.Logger, tempVolumeName, volumePath, chainID string, volSize uint64) error {
