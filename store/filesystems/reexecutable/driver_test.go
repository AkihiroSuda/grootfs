...
import (
	...
	"code.cloudfoundry.org/grootfs/store/filesystems/reexecutable/reexecutablefakes"
...
var _ = Describe("Driver", func() {
	var (
		internalDriver    *reexecutablefakes.FakeInternalDriver
		idMapper          *unpackerfakes.FakeIDMapper
		driver            *reexecutable.Driver
		logger            lager.Logger
	...
	JustBeforeEach(func() {
		internalDriver = new(reexecutablefakes.FakeInternalDriver)
		idMapper = new(unpackerfakes.FakeIDMapper)
		driver = reexecutable.New(internalDriver, idMappings, idMapper, fakeCommandRunner)
