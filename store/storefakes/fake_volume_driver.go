...
type FakeVolumeDriver struct {
	...
	VolumeSizeStub        func(string) (int64, error)
...
func (fake *FakeVolumeDriver) Volumes() []string {
...
func (fake *FakeVolumeDriver) VolumesReturns(result1 []string) {
...
func (fake *FakeVolumeDriver) VolumesReturnsOnCall(i int, result1 []string) {
	fake.VolumesStub = nil
...
func (fake *FakeVolumeDriver) VolumeSize(arg1 string) (int64, error) {
	...
	fake.recordInvocation("VolumeSize", []interface{}{arg1})
	fake.volumeSizeMutex.Unlock()
	if fake.VolumeSizeStub != nil {
		return fake.VolumeSizeStub(arg1)
	}
	if specificReturn {
...
func (fake *FakeVolumeDriver) VolumeSizeArgsForCall(i int) string {
	fake.volumeSizeMutex.RLock()
	defer fake.volumeSizeMutex.RUnlock()
	return fake.volumeSizeArgsForCall[i].arg1
}
